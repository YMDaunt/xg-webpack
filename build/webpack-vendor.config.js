...
module.exports = {
    ...
    output: {
        ...
        filename: 'js/vendor/[name].[chunkhash:8].js',
    ...
    plugins: [
        new webpack.DefinePlugin({
            'process.env': {
                REPORT: JSON.stringify(process.env.REPORT)
            }
        }),
